module github.com/fox-one/mint-withdraw
...
require (
	...
	github.com/fox-one/mixin-sdk v1.4.9
	github.com/fox-one/mixin-sdk-go v1.6.18
...
require (
	...
	github.com/fox-one/pkg v1.5.8 // indirect
